...
class UploadVideoPage extends StatefulWidget {
  ...
  UploadVideoPage({required this.idChallenge, required this.idGruppo});
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child:
                        Text("Upload video for [Challenge Name]", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 20)),
                  ),
                  CupertinoButton(
                    padding: EdgeInsets.zero,
                    onPressed: () async {
