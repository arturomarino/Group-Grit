...
abstract class AppLocales {
  ...
  static const it = LangVo("Italiano", "Italian", "it", Locale("it"), "🇮🇹");
  static const fr = LangVo("Français", "French", "fr", Locale("fr"), "🇫🇷");
  static const de = LangVo("Deutsch", "German", "de", Locale("de"), "🇩🇪");
  static const es = LangVo("Español", "Spanish", "es", Locale("es"), "🇪🇸");
  static const available = <LangVo>[en,it,fr,de,es];
  static List<Locale> get supportedLocales => [en.locale,it.locale,fr.locale,de.locale,es.locale];
